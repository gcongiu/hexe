...
class Atom
{
  public:
    ...
    MMD_float** realloc_2d_MMD_float_array_fast(MMD_float**, int, int, int);
    MMD_float** create_2d_MMD_float_array_fast(int, int);
    void destroy_2d_MMD_float_array_fast(MMD_float**);
};
