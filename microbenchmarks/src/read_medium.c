...
#pragma omp parallel
    ...
    fieldB = malloc(sizeof(double)*(SIZE));
#else
    fieldA = memkind_malloc(MEMKIND_DEFAULT, sizeof(double)*(SIZE+1024*1024));
    fieldB = memkind_malloc(MEMKIND_HBW, sizeof(double)*(SIZE+1024*1024));
#endif
