...

{
  ...
  *x = (double*) memkind_malloc(MEMKIND_HBW, sizeof(double) * local_nrow);;
  (*A)->list_of_vals = (double*)   memkind_malloc(MEMKIND_LIST, sizeof(double) * local_nnz);
  (*A)->list_of_inds =(int*) memkind_malloc(MEMKIND_IND, sizeof(int) * local_nnz);
#else
